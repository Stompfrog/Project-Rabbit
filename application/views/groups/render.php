...
<div class="row">
	<div class="span10">
		<h2>Team Rocket <small>Created April 16th 2004</small></h2>
		<hr />
		...
		<h4>Members</h4>
		<ul>
			<li><a href="<?php echo base_url(); ?>index.php/artists/render">Chris Bewick</a></li>
			<li><a href="<?php echo base_url(); ?>index.php/artists/render">Claire Bloomer</a></li>
			<li><a href="<?php echo base_url(); ?>index.php/artists/render">Mark Robson</a></li>
		</ul>
	</div>
	<div class="span4">
