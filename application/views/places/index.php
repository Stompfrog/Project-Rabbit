...
<div class="row">
	<div class="span10">
		...
		<a class="btn success" href="reg1.html">Add a new place!</a>
       <hr />
		<h2>Latest Places</h2>
		<hr />
		<ul class="search-results">
			<li>
				...
				<span class="label success">Shop</span> <a class="pull-right" href="#">View profile &raquo;</a>
			</li>
			<li>
				<ul class="media-grid"><li><a href="#"><img alt="" src="http://placehold.it/60x60" class="thumbnail"></a></li></ul>
				<h3><a href="#">Place Name</a></h3>
				<p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
				<span class="label success">Private residence</span> <a class="pull-right" href="#">View profile &raquo;</a>
			</li>
			<li>
				<ul class="media-grid"><li><a href="#"><img alt="" src="http://placehold.it/60x60" class="thumbnail"></a></li></ul>
				<h3><a href="#">Place Name</a></h3>
				<p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
				<span class="label success">Gallery</span> <a class="pull-right" href="#">View profile &raquo;</a>
			</li>
			<li>
				<ul class="media-grid"><li><a href="#"><img alt="" src="http://placehold.it/60x60" class="thumbnail"></a></li></ul>
				<h3><a href="#">Place Name</a></h3>
