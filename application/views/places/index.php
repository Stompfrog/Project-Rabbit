	...
	<div class="span10">
       ...
       <hr />
		...
		<div class="pagination">
			<ul>
				<li class="prev disabled"><a href="<?php echo base_url(); ?>index.php/places/render">&larr; Previous</a></li>
				<li class="active"><a href="<?php echo base_url(); ?>index.php/places/render">1</a></li>
				<li><a href="<?php echo base_url(); ?>index.php/places/render">2</a></li>
				<li><a href="<?php echo base_url(); ?>index.php/places/render">3</a></li>
				<li><a href="<?php echo base_url(); ?>index.php/places/render">4</a></li>
				<li><a href="<?php echo base_url(); ?>index.php/places/render">5</a></li>
				<li class="next"><a href="<?php echo base_url(); ?>index.php/places/render">Next &rarr;</a></li>
			</ul>
		</div>						
	</div>
	<div class="span4">
