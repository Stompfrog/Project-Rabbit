...
<div class="row">
	<div class="span10">
		<h2>Jelly Arts Centre <small>Added on June 16th 2004</small></h2>
		<hr />
		<h3>Paint, port and party</h3>
		...
		<h4>Map of Jelly Arts</h4>
		<ul class="media-grid">
			<li><a href="#"><img alt="" src="http://placehold.it/550x350" class="thumbnail"></a></li>
		</ul>
	</div>
	<div class="span4">
