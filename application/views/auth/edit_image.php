...
<div class="row">
	<div class="span10">
		...
		<?php echo form_open($this->uri->uri_string()); ?>
			<fieldset>
				<div class="clearfix">
				    <?php echo form_label('Gallery name', $image_name['id']); ?>
				    <div class="input">
			            <?php echo form_input($image_name); ?>
			            <?php echo form_error($image_name['name']); ?>
			            <?php echo isset($errors[$image_name['name']])?$errors[$image_name['name']]:''; ?>
				    </div>
				</div>
				<div class="clearfix">
