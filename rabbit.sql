...
--
-- Host: localhost
-- Generation Time: May 23, 2012 at 08:01 PM
...
INSERT INTO `friends` VALUES(88, 6, 1, 'friend', '2012-05-19');
INSERT INTO `friends` VALUES(89, 1, 6, 'friend', '2012-05-19');
...
INSERT INTO `users` VALUES(1, 'roppa_uk', '$2a$08$vSOeF4KmPaXh/sTV6B9Ay.OAtMwn/4Rxci3PQHr6CNzi4wYcDJm3G', 'roppa_uk@hotmail.com', 1, 0, NULL, NULL, NULL, NULL, 'a5991f5072eaa2569d015d796cad4f6f', '127.0.0.1', '2012-05-23 19:57:46', '2012-01-21 13:34:48', '2012-05-23 19:57:46');
INSERT INTO `users` VALUES(2, 'sompfrog', '$2a$08$xxAl6ZwZGAMkeO2KLBcpHO3PVpIDULTm7b6w/Gc8pCOPjjP0YLslK', 'chrisbewick@gmail.com', 1, 0, NULL, NULL, NULL, NULL, '700c92cfe378fdd91ef7b89fdb3a2d03', '127.0.0.1', '0000-00-00 00:00:00', '2012-01-28 10:12:30', '2012-01-28 02:12:59');
INSERT INTO `users` VALUES(3, 'neslisever', '$2a$08$lL2NJTtvb4N1HICUOsDDgOpMDchwSmD5HthcFozB1xburUlG9.WFW', 'neslisever@yahoo.com', 1, 0, NULL, NULL, NULL, NULL, 'a629e15716b12a16846e1416c5fd7453', '127.0.0.1', '2012-01-28 23:02:47', '2012-01-28 14:33:48', '2012-01-28 15:02:47');
INSERT INTO `users` VALUES(4, 'joch', '$2a$08$.QkhtqleQeoibY0NmVKyr.2L4f44k/kP9A4u0sbRRfQq68FZV56YO', 'joch@talktalk.net', 1, 0, NULL, NULL, NULL, NULL, '9a84fd9df2da3d9b71729212fb0f9a76', '127.0.0.1', '2012-03-31 18:38:45', '2012-02-10 20:59:22', '2012-03-31 10:38:45');
INSERT INTO `users` VALUES(5, 'maribell64', '$2a$08$vbejdYwcB12ALKiPsSaPKeTNI/AsXboX.310lJx.SoHh3l9uBTofm', 'maribell_vargas7@hotmail.com', 1, 0, NULL, NULL, NULL, NULL, '4cd08f03e2527ac592a2d1a047420711', '127.0.0.1', '2012-04-17 11:37:08', '2012-04-06 17:59:23', '2012-04-17 03:37:08');
INSERT INTO `users` VALUES(6, 'helen_pailing', '$2a$08$PERf8hy4tX8X8SQocRzDp.yjhl4D0TCblqMXX1.aZTDpKseaa9rAK', 'helen_pailing@hotmail.com', 1, 0, NULL, NULL, NULL, NULL, 'af287d2561040208d02a725c56d56237', '127.0.0.1', '2012-05-19 21:18:23', '2012-05-19 10:12:50', '2012-05-19 21:18:23');
...
INSERT INTO `user_interests` VALUES(1, 1, 3);
INSERT INTO `user_interests` VALUES(2, 1, 4);
...
ALTER TABLE `user_interests`
  ADD CONSTRAINT `FK_role_type_id` FOREIGN KEY (`role_type_id`) REFERENCES `interests` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
